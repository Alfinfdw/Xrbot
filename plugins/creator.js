...
if (command == 'creator') {
  ...
  const sentMsg = await conn.sendContactArray(m.chat, [
    [`${nomorown}`, `${await conn.getName(nomorown+'@s.whatsapp.net')}`, `Developer Bot `, `Don't call me`, `niluh`, `Indonesia`, `https://github.com/kepo1`, `Bapaknya Loh lucu banget rek😁`],
    [`${conn.user.jid.split('@')[0]}`, `${await conn.getName(conn.user.jid)}`, `Bot WhatsApp`, `Don't spam/call me`, `Nothing`, `Indonesia`, `https://github.com/kepo`, `Maklor sebaskom full😱`]
  ], fkontak)
